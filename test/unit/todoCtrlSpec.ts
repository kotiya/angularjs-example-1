...
(function () {
    ...
    describe('Todo Controller', function () {
        let ctrl: any, scope: any, store: any;

        // Load the module containing the app, only 'ng' is loaded by default.
        beforeEach(module('todomvc'));

        beforeEach(inject(function ($controller: any, $rootScope: any, localStorage: any) {
            scope = $rootScope.$new();
            ...
            localStorage._saveToLocalStorage = function (todos: any) {
        ...
        describe('the filter', function () {
            ...
            describe('being at /active', function () {
                it('should filter non-completed', inject(function ($controller: any) {
                    ctrl = $controller('TodoCtrl', {
                        $scope: scope,
                        store: store,
                        $routeParams: {
            ...
            describe('being at /completed', function () {
                it('should filter completed', inject(function ($controller: any) {
                    ctrl = $controller('TodoCtrl', {
                        $scope: scope,
                        $routeParams: {
                            status: 'completed'
